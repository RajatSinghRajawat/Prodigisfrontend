...
import { useOrganisationforgetpassotpverifyMutation, useVerifyOtpOrganiserPhoneMutation } from '../store/api/apiSlice';
...
const Organiserforgetvefiemail = () => {
    ...
    const [verifyforgetpassOtp, { isLoading }] = useOrganisationforgetpassotpverifyMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status) {
                navigate("/organiser/create-new-password", { state: { email: email } })
            }
